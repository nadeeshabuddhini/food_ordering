...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Food and Restorent </title>
                    ...
                    <div class="row">	
                        <div class="col-md-5 col-md-offset-3 col-sm-12 text-right">
                            <div class="call_us_text">
								...
								<a href=""><i class="fa fa-phone"></i>038 2232120</a>
							</div>
                        </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    ...
                                    <ul class="nav navbar-nav navbar-right">
                                        ...
                                        <li><a href="loginphp.php" class="booking">login</a></li>
                                    </ul>
                                </div><!-- /.navbar-collapse -->
                            </div><!-- /.container-fluid -->
                        </nav>
                        ...
                        <div class="main_slider text-center">
                            <div class="col-md-12">
                                <div class="main_slider_content wow zoomIn" data-wow-duration="1s">
                                    ...
                                    <li><a href="userreg.php" class="booking btn btn-primary">Register Here</a></li>
                                </div>
                            </div>	
                        </div>
                    ...
                    <div class="abouts_content">
                        ...
                        <div class="col-md-6">
                            <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                                <h4>About us</h4>
                                <h3>WE ARE TASTY</h3>
                                <p> We have sought out and secured professional services to evaluate, validate quality, and Healthy of products and product life cycle. These additional professional services will allow Cliveannes Foods Company to ensure quality of foods with state, federal, local, and industry group certifications. They are producing all kind of pure spices and supplies and distributes locally.  
                                </p>
                                ...
                                <div class="main_features_content text-left">
                                    <div class="col-md-6">
                                        <div class="single_features_text">
                                            ...
                                            <p>Lour source for all things spicy has to include spicy food!

                                                Browse through our menus above to find the perfect way to spice up your day!

                                                We have categories for every taste. Whether you want to heat up your meal with a top rated hot sauce, whip up one of our spicy recipes, or find a fiery restaurant to please your palate. We have everything a chilehead could ask for!</p>
                            ...
                            <div class="main_portfolio_content">
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    ...
                                    <div class="portfolio_images_overlay text-center">
                                        ...
                                        <a href="loginphp.php" class="btn btn-primary">+add cart</a>
                                    </div>
                                </div>
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                ...
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
                                    ...
                                    <div class="portfolio_images_overlay text-center">
                                        <h6>Italian Source Mushroom</h6>
                                        <p class="product_price">$12</p>
                                        <a href="loginphp.php" class="btn btn-primary">Click here</a>
                                    </div>								
                                </div>
                                <div class="col-md-3 col-sm-4 col-xs-6 single_portfolio_text">
